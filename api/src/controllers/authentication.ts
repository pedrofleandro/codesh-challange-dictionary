...
import {getUserByEmail, getUserBySessionToken, createNewUser} from '../db/users'
...
export const login = async (req: express.Request, res: express.Response) => {
  try {
    ...
    res.cookie('DICTIONARY-AUTH', user.authentication.sessionToken, { 
      domain: 'localhost', 
      path: '/',
      httpOnly: true,       
      secure: false,        
...
export const logout = async (req: express.Request, res: express.Response) => {
  try {
    res.clearCookie('DICTIONARY-AUTH', {
      domain: 'localhost', 
      path: '/',
      httpOnly: true,
      secure: false,
